 ...
 **/
public class RuleEngineJsonUtils {
...
//			mapper.configure(SerializationFeature.WRAP_ROOT_VALUE CLOSE_CLOSEABLE)
    ...
    public static boolean validateJson(String json) {
        boolean flag = false;
        try {
            RuleEngineJsonUtils.fromJson(json, Map.class);
            return true;
        } catch (Exception e) {
        }
        try {
            RuleEngineJsonUtils.fromJson(json, List.class);
            return true;
        } catch (Exception e) {
        }
        return flag;
    ...
    public static String appendJson(String json, Object[] ... data) throws RuntimeException {
        Map map = null;
        try {
            map = RuleEngineJsonUtils.fromJson(json, Map.class);
        } catch (Exception e) {
