...
public class Test2 {
    ...
    public void testCount() {
        ...
        QueryResult queryResult = influxDBConnection.executeCommand("SELECT count(time) FROM m1");
    ...
    public void testSelect() {
        long s = System.currentTimeMillis();
        QueryResult queryResult = influxDBConnection.executeCommand("SELECT * FROM m1 where time >= '2022-11-28T00:00:00Z' and time <= '2022-11-29T00:00:00Z' limit 10000");
        System.out.println("耗时：" + (System.currentTimeMillis() - s) + "毫秒");
        System.out.println(queryResult.getResults().get(0).getSeries().get(0).getValues().size());
    }
