...
public class Template2DocxUtils {
    ...
    public static String getFreemarkerContent(Map dataMap, String templateName) {
        ...
        try {
            ...
            templateName = templateName.replace(StrConstantEnum.BACKSLASH.getValue(), StrConstantEnum.SLASH.getValue());
            //设置模板所在文件夹
            String path = StrConstantEnum.SLASH.getValue();
            String name = templateName;
            if (templateName.contains(StrConstantEnum.SLASH.getValue())) {
                path = StringUtils.substringBeforeLast(templateName, StrConstantEnum.SLASH.getValue()) + StrConstantEnum.SLASH.getValue();
                name = StringUtils.substringAfterLast(templateName, StrConstantEnum.SLASH.getValue());
            }
